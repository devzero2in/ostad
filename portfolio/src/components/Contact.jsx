...
const Contact = () => {
  return (
    <section
      id="contact"
      className="w-full max-w-[1440px] h-[520px] pt-[120px] px-[255px] bg-white flex flex-col items-center gap-[73px] mx-auto"
    >
      {/* Contact Title */}
      <div className="relative w-full flex items-center justify-center">
        <hr className="absolute left-0 right-0 border-t border-black" />
        <h2 className="bg-[#FFFFFF] px-4 text-[24px] font-medium z-10">Contact</h2>
      </div>
